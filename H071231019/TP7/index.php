...
<head>
    ...
    <title>Institute Technology Bandung</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top no-print">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="./assets/img/Logo-ITB.png" alt="UI Logo">Institute Technology Bandung Student Data</a>
