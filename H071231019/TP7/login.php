...
<head>
    ...
    <title>Login - ITB</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
body {
    background-image: linear-gradient(to top, #005aab80, #005aab00 50%), url(assets/img/Background-ITB.jpg);
            ...
            <div class="col-md-5">
                <div class="card shadow animated">
                    <div class="card-header">
                        <img src="./assets/img/Logo-ITB.png" alt="UI Logo" class="ui-logo">
                        <h4 class="card-title text-black text-center mb-0">INSTITUTE TECHNOLOGY BANDUNG</h4>
                    </div>
