...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, #FFE3E3 0%, #FEF9F2 100%);
            min-height: 100vh;
        }
        .navbar {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fas fa-university me-2"></i>Dashboard Profile</a>
